...
testset = dataloader.SuperSloMo(root='./test', transform=transform, randomCropSize=(640, 352), train='test')
...
def predict():
    ...
    with torch.no_grad():
        for testIndex, (testData, _) in enumerate(testloader, 0):
            ...
            save_path = os.path.join('/Users/hyc/workspace/Super-SloMo/intrpOut_test', str(testIndex))
            ...
            create_webp(save_path, '{}.gif'.format(testIndex), min_size=320.0)
            break
